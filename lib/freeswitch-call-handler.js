  ...
  return payloadParser(opts)
    ...
    .then((opts) => {
      ...
      if (rapidsosheaderscount > 0) {
		  ...
		  call_id = opts.recordingData['recording'].participant[0].extensiondata[0]['apkt:header'][3]['value'][0];
                  console.log("Callid: " + call_id);
                  if (call_id.indexOf(recording_filename) == -1) {
                      console.log('This is an outgoing call');
                      recording_filename = call_id;
                  } else {
